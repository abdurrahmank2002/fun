<?php
@include 'config.php';
// Establish database connection using appropriate credentials

// Retrieve total sellers
$selectSellers = mysqli_query($conn, "SELECT COUNT(*) AS totalSellers FROM crud");
$rowSellers = mysqli_fetch_assoc($selectSellers);
$totalSellers = $rowSellers['totalSellers'];

// Retrieve total products
$selectProducts = mysqli_query($conn, "SELECT COUNT(*) AS totalProducts FROM producttb");
$rowProducts = mysqli_fetch_assoc($selectProducts);
$totalProducts = $rowProducts['totalProducts'];

// Retrieve total amount
$selectAmount = mysqli_query($conn, "SELECT SUM(total_price) AS totalAmount FROM orders");
$rowAmount = mysqli_fetch_assoc($selectAmount);
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        ...
                        <p>here,you can check the overall details about the seller,product and also amount..... and so no</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="our_main_box">
                        <div class="our_img">
                            <figure><img src="images/sellerimage1.avif" alt="#" /></figure>
                        </div>
                        <div class="our_text">

                            <h3>Sellers</h3>

                            <a class="read_more" href="#">20</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="our_main_box">
                        <div class="our_img">
                            <figure><img src="images/sellerimage8.avif" alt="#" /></figure>
                        </div>
                        <div class="our_text">

                            <h3>Products</h3>

                            <a class="read_more" href="#">35</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 ">
                ...
                <div class="col-md-4 margin_top">
                    <div class="our_main_box">
                        <div class="our_img">
                            <figure><img src="images/amounts.avif" alt="#" /></figure>
                        </div>
                        <div class="our_text">

                            <h3>Amount</h3>

                            <a class="read_more" href="#">$20000</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="titlepage">
                    <h2>Welcome to the Dashboard!</h2>
                    <p>Here, you can check the overall details about the seller, product, and also the amount... and so on.</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="our_main_box">
                    ...
                    <div class="our_text">
                        <h3>Sellers</h3>
                        <a class="read_more" href="#"><?php echo $totalSellers; ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="our_main_box">
                    ...
                    <div class="our_text">
                        <h3>Products</h3>
                        <a class="read_more" href="#"><?php echo $totalProducts; ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 ">
                <div class="our_main_box"></div>
            </div>
            <div class="col-md-4 margin_top">
                <div class="our_main_box">
                    <div class="our_img">
                    ...
                    <div class="our_text">
                        <h3>Amount</h3>
                        <a class="read_more" href="#"><?php echo '$' . $totalAmount; ?></a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="container">
                                    <div class="carousel-caption ">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="test_box">
                                                    <i><img src="images/Screenshot_20230515_112230-modified.png"style="width:200px;height:200px" alt="#"/></i>
                                                    <h4>Abdur</h4>
                                                    <p>Haii,i am Abdur rahman currently i am studying in kumaraguru college of technology which is located in coimbatore.we are in II year 4th semester is going.these project is about the relation ship between
                                                        the owner and seller also it is a DBMS related projects.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="container">
                                    <div class="carousel-caption">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="test_box">
                                                    <i><img src="images/Screenshot_20230515_112257-modified.png"
                                                        style="width:200px;height:200px" alt="#"/></i>
                                                    <h4>Nithiesh </h4>
